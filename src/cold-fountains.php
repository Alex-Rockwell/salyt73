...
<head>
    ...
    <title>Купить холодные фонтаны в Ульяновске</title>
    <meta name="description" content="Взлетающие разноцветные искры, напоминающие извержение огненного вулкана в миниатюре – вот что такое огненный фонтан. Дорожка из огненных фонтанов – сказочное зрелище, делающее прогулку по ней незабываемой.">
    <meta name="keywords" content="холодный фонтан, холодный фонтан фейерверк, фонтаны на свадьбу холодные, фонтаны холодные купить">
    <meta name="robots" content="index, follow">
    
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="css/pages/cold-fountains.min.css">
            ...
            <div class="description__wrapper">
                ...
                <ul class="description__gallery">
                    <li class="description__gallery-item">
                        <a class="description__gallery-link" href="img/pages/cold-fountains/gallery/1.jpg" data-fslightbox="cold-fountains">
                            <img class="description__gallery-image" src="img/pages/cold-fountains/gallery/1.jpg">
                        </li>
                    </li>
                    <li class="description__gallery-item">
                        <a class="description__gallery-link" href="img/pages/cold-fountains/gallery/2.jpg" data-fslightbox="cold-fountains">
                            <img class="description__gallery-image" src="img/pages/cold-fountains/gallery/2.jpg">
                        </li>
                    </li>
                    <li class="description__gallery-item">
                        <a class="description__gallery-link" href="img/pages/cold-fountains/gallery/3.jpg" data-fslightbox="cold-fountains">
                            <img class="description__gallery-image" src="img/pages/cold-fountains/gallery/3.jpg">
                        </li>
                    </li>
                    <li class="description__gallery-item">
                        <a class="description__gallery-link" href="img/pages/cold-fountains/gallery/4.jpg" data-fslightbox="cold-fountains">
                            <img class="description__gallery-image" src="img/pages/cold-fountains/gallery/4.jpg">
                        </li>
                    </li>
                </ul>
            </div>
            <picture>
                <source srcset="imgwebp/pages/cold-fountains/bg.webp" type="image/webp">
                <img src="img/pages/cold-fountains/bg.jpg" alt="Холодные фонтаны" class="description__img">
            </picture>
        </section>
        ...
        <section class="content section">
            <div class="content__wrapper">
                <div class="content__info">
                    <h2 class="section-title">Ку&shy;пить хо&shy;лод&shy;ный фон&shy;тан на свадь&shy;бу в Уль&shy;я&shy;новс&shy;ке</h2>
                    <div class="content__descr">
                        <p class="content__descr-text">Холодный сценический фонтан не разбрасывает горячих искр (в отличие от бытовых), а это значит, что вы можете продумать целый сценарий для своего выхода: к холодным фонтанам можно подходить вплотную, его искры не способны причинить вред даже воздушному свадебному платью!</p>
                        <p class="content__descr-text">Это основное отличие холодных фонтанов от бытовых, продающихся в пиротехнических магазинах. Что нужно знать, если вы хотите заказать холодные фонтаны на свадьбу? Не стоит экономить на своих эмоциях. Сценическая пиротехника не продается в обычных магазинах, а если вы приобретаете бытовые фонтаны, безопасными они не будут. Покупая бытовую пиротехнику самостоятельно, вы берете всю ответственность на себя: за то, как они отработают и за то, как их поджечь.</p>
                    </div>
                ...
                <picture>
                    <source srcset="imgwebp/pages/cold-fountains/content/order.webp" type="image/webp">
                    <img src="img/pages/cold-fountains/content/order.jpg" alt="Холодные фонтаны" class="content__img">
                </picture>
            </div>
        </section>
...
г. Чердаклы, ул. Советская 34</a><br>
    ...
    <script src="js/pages/cold-fountains.js"></script>
