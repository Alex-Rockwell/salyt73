(() => {
    ...
    const t = function ({modalSelector: e, modalActiveClass: t, modalBtnSelector: c, closeOnClickOnBg: l, overflow: o, hasScroll: a, automatically: r}) {
        ...
        c = function ({formSelector: e, formInactiveClass: t, inputSelector: c, spinnerSelector: l, spinnerActiveClass: o, formTitleSelector: a, formTitleInactiveClass: r, messageSuccessSelector: s, messageErrorSelector: n, messageActiveClass: i, url: d}) {
            const m = document.querySelector(e), u = m.querySelectorAll(c), _ = document.querySelector(a),
                v = document.querySelector(l), S = document.querySelector(s), p = document.querySelector(n),
                f = m.querySelector(".form-token");
            m.addEventListener("submit", (function (e) {
                e.preventDefault(), f.value = "NOSPAM", r && _.classList.add(r), t && m.classList.add(t), v.classList.add(o);
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        (function () {
            ...
            modalBtnSelector: ".description__more"
        }), t({
            modalSelector: ".more__modal",
            modalActiveClass: "modal_active",
            modalBtnSelector: ".content__order"
        }), new Swiper(".launch__text-swiper", {
            autoplay: {delay: 1e3},
            direction: "vertical",
            loop: !0,
            speed: 0
        }), new Swiper(".launch__images-swiper", {
            loop: !0,
            navigation: {
                nextEl: ".launch__images-swiper .swiper-button-next",
                prevEl: ".launch__images-swiper .swiper-button-prev"
            },
            speed: 800
